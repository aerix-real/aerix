...
function buildLegacySignalShape(symbol, strategyResult, snapshot, strategyMode) {
  ...
  return {
    ...
    direction: strategyResult.preSignalDirection || strategyResult.signal,
    signal: strategyResult.signal,
    signalState: strategyResult.signalState || (strategyResult.signal === "WAIT" ? "WAIT" : "CONFIRMED"),
    signalStateLabel: strategyResult.signalStateLabel || (strategyResult.signal === "WAIT" ? "Aguardando oportunidade" : "Sinal confirmado"),
    executionAllowed: strategyResult.executionAllowed === false ? false : strategyResult.signal !== "WAIT",
    preSignal: Boolean(strategyResult.preSignal),
    preSignalDirection: strategyResult.preSignalDirection || null,
    preSignalStatus: strategyResult.preSignalStatus || null,
    preSignalStatusLabel: strategyResult.preSignalStatusLabel || null,
    preSignalMessage: strategyResult.preSignalMessage || null,
    preSignalReason: strategyResult.preSignalReason || null,
    preSignalCreatedAt: strategyResult.preSignalCreatedAt || null,
    suggestedEntryAt: strategyResult.suggestedEntryAt || null,
    preSignalExpiresAt: strategyResult.preSignalExpiresAt || null,
    pendingConfirmations: strategyResult.pendingConfirmations || [],
    preSignalKey: strategyResult.preSignalKey || null,
    preliminaryConfidence: strategyResult.preliminaryConfidence || null,
    ...
    preSignalScoreLabel: strategyResult.preSignalScoreLabel || null,
...
async function executeSymbolAnalysis(userId, symbol, providedSnapshot = null) {
  ...
  const finalResult = {
    ...
    preSignalScore: strategyResult.preSignal ? strategyResult.preSignalScore : preCheckMetrics.preScore,
    preSignalScoreLabel: strategyResult.preSignalScoreLabel || null,
  ...
  const analysisResult = {
    ...
    signalState: finalResult.signalState || (finalResult.signal === "WAIT" ? "WAIT" : "CONFIRMED"),
    signalStateLabel: finalResult.signalStateLabel || (finalResult.signal === "WAIT" ? "Aguardando oportunidade" : "Sinal confirmado"),
    executionAllowed: finalResult.executionAllowed === false ? false : finalResult.signal !== "WAIT",
    preSignal: Boolean(finalResult.preSignal),
    preSignalDirection: finalResult.preSignalDirection || null,
    preSignalStatus: finalResult.preSignalStatus || null,
    preSignalStatusLabel: finalResult.preSignalStatusLabel || null,
    preSignalMessage: finalResult.preSignalMessage || null,
    preSignalReason: finalResult.preSignalReason || null,
    preSignalCreatedAt: finalResult.preSignalCreatedAt || null,
    suggestedEntryAt: finalResult.suggestedEntryAt || null,
    preSignalExpiresAt: finalResult.preSignalExpiresAt || null,
    pendingConfirmations: finalResult.pendingConfirmations || [],
    preSignalKey: finalResult.preSignalKey || null,
    partialScore: finalResult.partialScore || null,
    preliminaryConfidence: finalResult.preliminaryConfidence || null,
    ...
    preSignalScoreLabel: finalResult.preSignalScoreLabel || null,
